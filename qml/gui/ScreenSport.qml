    ...
    Image {
        ...
        Item {
            ...
            Item {
                ...
                Image {
                    ...
                    width: 48
                    height: 36
                    source: "qrc:/images/TempWarning.png"
                    visible: true
                }
                ...
                Image {
                    ...
                    width: 47
                    height: 40
                    source: "qrc:/images/batteryWarning.png"
        ...
        Item {
            ...
            Image {
                ...
                width: 53
                height: 48
                source: "qrc:/images/brakeWarnSignal.png"
            }
            Colorize {
...
//            }
            ...
            Image {
                ...
                width: 44
                height: 45
                source: "qrc:/images/engineFailure.png"
                rotation: 0.018
            }
            Colorize {
        ...
        Keys.onPressed: {
            ...
            if (event.key === Qt.Key_W){
                ...
                if (speedometer.value > 239){
                    ...
                    speedometer.value += 1;
                    speedText.text = speedometer.value;
